...
def test_all_3acre_under_15k(record_xml_attribute):
    ...
    web_app_setup.go_to_landwatch_search(driver, SiteToScrape.landwatch, search_area='any', min_acreage=3,
                                         max_price=15000)
    ...
    try:
        ...
        search_page.write_to_csv('test-reports/ANY_GT3ACRES_LT15k.csv', optimal_results_list)
